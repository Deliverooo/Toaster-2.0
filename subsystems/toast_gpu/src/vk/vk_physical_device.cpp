#include "toast_gpu/vk/vk_physical_device.hpp"

namespace toaster::gpu
{
	auto isDeviceSuitable(vk::PhysicalDevice  p_physical_device, const std::unordered_set<String> &p_required_extensions,
	...
	VKPhysicalDevice::VKPhysicalDevice(vk::raii::Instance& p_instance, const VKPhysicalDeviceSpecInfo &p_spec_info)
	{
		_init(p_instance, p_spec_info);
	}
	...
	auto VKPhysicalDevice::_init(vk::raii::Instance& p_instance, const VKPhysicalDeviceSpecInfo &p_spec_info) -> void
	{
		auto physical_devices{p_instance.enumeratePhysicalDevices()};
