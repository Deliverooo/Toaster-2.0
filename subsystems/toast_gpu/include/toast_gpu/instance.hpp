...
namespace toaster::gpu
{
	...
	class TST_GPU_API FunctionDispatcher
	{
	public:
		static auto initBaseFunctions() -> void;                            // Call before creating the instance
		static auto initInstanceFunctions(vk::Instance p_instance) -> void; // Call right after creating the instance
		static auto initDeviceFunctions(vk::Device p_device) -> void;       // Call right after creating the logical device

		static auto get() -> const vk::detail::DispatchLoaderDynamic &;

	private:
		static vk::detail::DispatchLoaderDynamic s_dldy;
	};
