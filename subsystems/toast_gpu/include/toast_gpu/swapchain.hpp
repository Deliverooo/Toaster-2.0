...
namespace toaster::gpu
{
	class TST_GPU_API Swapchain
	{
		...
		TST_REGISTER_DEPENDENCY(ResourceManager, ResourceManager, resourceManager)

	public:
		Swapchain(ResourceManager &p_resource_manager, vk::SurfaceKHR p_surface, uint32 p_max_frames_in_flight, uint32 p_initial_width,
				  uint32  p_initial_height);
		~Swapchain();
