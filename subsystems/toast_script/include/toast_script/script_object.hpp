...
namespace toaster::script
{
	...
	public:
		...
		auto getStaticFieldValue(const String &p_field_name, Type &p_out_value) -> void;
		template<typename Type>
		auto setStaticFieldValue(const String &p_field_name, const Type &p_value) -> void;
		...
		[[nodiscard]] auto getField(const String &p_field_name) const -> MonoClassField *;
		...
		[[nodiscard]] auto getNamespace() const -> const String &;
	...
	public:
		...
		template<typename Type>
		auto getFieldValue(const String &p_field_name, Type &p_out_value) -> void
		{
		...
		template<typename Type>
		auto setFieldValue(const String &p_field_name, const Type &p_value) -> void
		{
			MonoClassField *field{mono_class_get_field_from_name(m_class.getClass(), p_field_name.c_str())};
	...
	template<typename Type>
	auto Class::getStaticFieldValue(const String &p_field_name, Type &p_out_value) -> void
	{
	...
	template<typename Type>
	auto Class::setStaticFieldValue(const String &p_field_name, const Type &p_value) -> void
	{
		MonoClassField *field{mono_class_get_field_from_name(m_class, p_field_name.c_str())};
