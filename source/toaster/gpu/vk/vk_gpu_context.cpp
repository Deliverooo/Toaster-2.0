...
namespace toaster::gpu::vk
{
	VkBool32 VKGPUContext::_debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT      messageSeverity, [[maybe_unused]] VkDebugUtilsMessageTypeFlagsEXT messageType,
	...
	void VKGPUContext::init(vk::SurfaceKHR p_window_surface)
	{
	...
	vk::Instance VKGPUContext::getInstance() const
	{
		return m_vulkanInstance;
	}

	bool VKGPUContext::isValidationEnabled() const
	{
		return m_enableValidationLayers;
	}

	bool VKGPUContext::isValidationLayerSupported(const std::string &p_layer_name) const
	{
	...
	const std::unordered_set<std::string> &VKGPUContext::getEnabledValidationLayers() const
	{
		return m_enabledValidationLayers;
	}

	bool VKGPUContext::isInstanceExtensionEnabled(const std::string &p_extension_name) const
	{
		return m_enabledInstanceExtensions.contains(p_extension_name);
	}

	bool VKGPUContext::isInstanceExtensionSupported(const std::string &p_extension_name) const
	{
	...
	const std::unordered_set<std::string> &VKGPUContext::getEnabledInstanceExtensions() const
	{
		return m_enabledInstanceExtensions;
	}

	bool VKGPUContext::isDeviceExtensionEnabled(const std::string &p_extension_name) const
	{
		return m_enabledDeviceExtensions.contains(p_extension_name);
	}

	bool VKGPUContext::isDeviceExtensionSupported(const std::string &p_extension_name) const
	{
	...
	const std::unordered_set<std::string> &VKGPUContext::getEnabledDeviceExtensions() const
	{
		return m_enabledDeviceExtensions;
	}

	vk::PhysicalDevice VKGPUContext::getPhysicalDevice() const
	{
		return m_physicalDevice;
	}

	vk::PhysicalDeviceFeatures VKGPUContext::getPhysicalDeviceFeatures() const
	{
		return m_physicalDevice.getFeatures();
	}

	vk::PhysicalDeviceProperties VKGPUContext::getPhysicalDeviceProperties() const
	{
	...
	uint32 VKGPUContext::findMemoryTypeIndex(uint32 p_type_filter, vk::MemoryPropertyFlags p_flags) const
	{
	...
	vk::Format VKGPUContext::findSupportedFormat(const std::vector<vk::Format> &p_candidates, vk::ImageTiling p_tiling, vk::FormatFeatureFlags p_features) const
	{
	...
	VKGPUContext::QueueFamilyIndices VKGPUContext::findQueueFamilies(vk::PhysicalDevice p_physical_device, vk::SurfaceKHR p_window_surface) const
	{
	...
	bool VKGPUContext::checkDeviceExtensionSupport(vk::PhysicalDevice p_physical_device) const
	{
	...
	VKGPUContext::SwapchainSupportDetails VKGPUContext::querySwapchainSupport(vk::PhysicalDevice p_physical_device, vk::SurfaceKHR p_window_surface) const
	{
	...
	vk::SurfaceFormatKHR VKGPUContext::chooseSwapchainFormat(const std::vector<vk::SurfaceFormatKHR> &p_available_formats) const
	{
	...
	vk::PresentModeKHR VKGPUContext::choosePresentMode(const std::vector<vk::PresentModeKHR> &p_available_present_modes) const
	{
	...
	vk::Extent2D VKGPUContext::chooseExtent(const vk::SurfaceCapabilitiesKHR &p_capabilities, GLFWwindow *p_target_window) const
	{
	...
	vk::Device VKGPUContext::getLogicalDevice() const
	{
		return m_logicalDevice;
	}

	vk::Queue VKGPUContext::getGraphicsQueue() const
	{
		return m_graphicsQueue;
	}

	vk::Queue VKGPUContext::getPresentQueue() const
	{
		return m_presentQueue;
	}

	nvrhi::IDevice *VKGPUContext::getNVRHIDevice() const
	{
		return m_nvrhiDevice.Get();
	}

	nvrhi::Format VKGPUContext::getSwapchainFormat() const
	{
	...
	void VKGPUContext::_pickPhysicalDevice(vk::SurfaceKHR p_window_surface)
	{
	...
	void VKGPUContext::_createNVRHIObjects()
	{
	...
	bool VKGPUContext::_checkValidationLayerSupport() const
	{
	...
	bool VKGPUContext::_isDeviceSuitable(vk::PhysicalDevice p_physical_device, vk::SurfaceKHR p_window_surface) const
	{
