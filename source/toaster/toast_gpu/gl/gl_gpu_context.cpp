...
namespace toaster::gpu
{
											   ...
											   const void *p_user_param)
	{
		...
		{
			case gl::DebugSeverity::eNotification: { break; }
			case gl::DebugSeverity::eLow:
			case gl::DebugSeverity::eMedium:
			{
				LOG_WARN("GL CALLBACK: {} | Source: {} | Severity: {} | Message: {}", gl::to_string(static_cast<gl::Error>(p_type)),
						 gl::to_string(static_cast<gl::DebugSource>(p_source)), gl::to_string(static_cast<gl::DebugSeverity>(p_severity)), p_message);
			}
			case gl::DebugSeverity::eHigh:
			{
